...
class LoginLayout(QtWidgets.QGridLayout):
    ...
    def login_clicked(self):
        ...
        self.parent.main_window.password = password
...
class ScanLayout(QtWidgets.QGridLayout, QtCore.QObject):
    ...
    def start_scan(self, interval: int):
        # TODO: Bez časových možností to padá: spravit
        ...
        timer.args = [session, start_date, end_date,
                      dates, accept]
    ...
    def report_scan_results(self, report: str):
        def alert(text: str):
