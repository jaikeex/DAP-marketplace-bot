    ...
    if is_empty(scan_response):
        ...
        for shift in shifts:
            if is_valid_offer(shift, dates):
                if accept:
                    accept_offer(shift, username, password)
...
def accept_offer(shift: dict, username: str, password: str) -> None:
    """
    ...
    :return: None
    """
    # Don't know why have to start a new session
    # but this shit doesn't fucking work otherwise...
